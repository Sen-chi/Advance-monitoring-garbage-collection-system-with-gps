...
<div class="sidebar">
  ...
  <!-- Changed <a> to <button> for better semantics -->
  <button class="sidebar-section <?= $isMunicipality ? 'active-dropdown' : '' ?>" type="button" onclick="toggleSidebarDropdown(event)">
    <span><i class="fas fa-city"></i> Municipality</span>
     <!-- Chevron icon for dropdown indicator -->
    <i class="fas fa-chevron-down dropdown-arrow"></i>
  </button>
  <div class="sidebar-dropdown-content <?= $isMunicipality ? 'show' : '' ?>">
    <a href="add_municipality.php" class="sidebar-link <?= $currentPage === 'add_municipality.php' ? 'active' : '' ?>"><i class="fas fa-plus"></i> Add Municipality Details</a>
    <a href="municipality_list.php" class="sidebar-link <?= $currentPage === 'municipality_list.php' ? 'active' : '' ?>"><i class="fas fa-list"></i> View Municipalities</a>
  </div>
</div> <!-- End .sidebar -->
